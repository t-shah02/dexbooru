...
{#if $authenticatedUser}
	{#if !$authenticatedUser.friendRequestsReceived.length}
		<p class="mb-6 text-sm text-center font-normal text-gray-500 lg:text-xl dark:text-gray-400">
			You need some more love :((
		</p>
	{:else}
